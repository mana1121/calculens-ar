          ...
          {CATEGORIES.map((cat) => (
            <div key={cat.label}>
              <div className="mb-3">
                ...
                <p className="text-white/30 text-xs font-mono">{cat.subtitle}</p>
              </div>
                ...
                {cat.keys.map((key) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <p className={`text-xs font-heading font-medium leading-tight ${isActive ? 'text-purple-300' : 'text-white/60'}`}>
